...
def get(url: str, **kwargs): return request("GET", url, **kwargs)
def post(url: str, **kwargs): return request("POST", url, **kwargs)
def put(url: str, **kwargs): return request("PUT", url, **kwargs)
def delete(url: str, **kwargs): return request("DELETE", url, **kwargs)
def patch(url: str, **kwargs): return request("PATCH", url, **kwargs)
def head(url: str, **kwargs): return request("HEAD", url, **kwargs)
def options(url: str, **kwargs): return request("OPTIONS", url, **kwargs)
